...
{
    [TestClass]
    public class RepositoryMobileUnitWithListTest
    {
        [TestMethod]
        public void TestAddMobileUnitToList()
        {
            ...
            mobile.Name = "mobile";
            RepositoryMobileUnitWithList repositoryOfMobileUnits = new RepositoryMobileUnitWithList();
            repositoryOfMobileUnits.Add(mobile);
            Assert.AreEqual(mobile, repositoryOfMobileUnits.GetMobile("mobile"));
        }
